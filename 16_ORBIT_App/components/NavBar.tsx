  ...
  return (
    <>
      ...
      <header className="fixed inset-x-0 top-0 z-50 flex h-16 items-center justify-between border-b border-black/8 bg-[#fffdf8]/94 px-3.5 backdrop-blur-2xl lg:hidden">
        <Link href="/" className="flex items-center gap-2.5"><BrandMark /><div><p className="text-[11px] font-black tracking-[-0.02em]">24MARCH STUDIO</p><p className="text-[8px] font-bold uppercase tracking-[0.14em] text-black/40">Command Center</p></div></Link>
        <Link href="/projects/new" className="inline-flex h-9 items-center gap-1.5 rounded-full border border-black/10 bg-black px-3 text-[10px] font-black text-white shadow-sm" aria-label="Créer un nouveau projet"><CommandIcon name="plus" className="h-4 w-4" /><span>Nouveau projet</span></Link>
      </header>
